                        ...
                        <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                            <div class="box box-primary">
                                ...
                                <form action="presupuestocli_control.php" method="post" accept-charset="utf-8" class="form-horizontal">
                                        ...
                                        <input type="hidden" name="vpre_cod" value="0">                                    
                                    <div class="box-body">
                                        <?php $fecha = consultas::get_datos("select current_date as pre_fechaemision");?>
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                <label>Fecha:</label>
                                                <input type="date" name="pre_fechaemision" 
                                                       class="form-control" value="<?php echo $fecha[0]['pre_fechaemision'];?>" disabled="">
                                            </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title"><i class="fa fa-plus"></i> <strong>Registrar Presuesto</strong></h4>
                        </div>
                        <form action="presupuestocli_control.php" method="post" accept-charset="UTF-8" class="form-horizontal">
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-10">
                                        <input type="text" name="vpre_descri" class="form-control" required="" autofocus="" placeholder="Ingrese la descripción del presupuesto"/>                                                
                                    </div>
                                </div>
                            </div>
                            <div class="modal-footer">
                                ...
                                <button type="submit" class="btn btn-success" data-title="Guardar presupuesto" rel="tooltip">
                                    <i class="fa fa-floppy-o"></i> Registrar
                                </button>
                            </div>
                        </form>
