                                                            ...
                                                            <div class="panel-body">
                                                                ...
                                                                <?php  break;
                                                                        case 2: //por proveedor 
                                                                            $proveedores = consultas::get_datos("select * from proveedor where prv_cod in(select prv_cod "
                                                                                    . "from pedido_cabcompra where id_sucursal =".$_SESSION['id_sucursal']." )"); ?>
                                                                <div class="form-group">
                                                                    <label class="control-label col-lg-2 col-sm-2 col-md-2">Proveedores:</label>
                                                                    <div class="col-lg-8 col-sm-8 col-md-8">
                                                                        <select class="form-control select2" name="vpro">
                                                                            <option value="">Seleccione un proveedor</option>
                                                                            <?php foreach ($proveedores as $proveedor) { ?>
                                                                                 <option value="<?php echo $proveedor['prv_cod'];?>">
                                                                                     <?php echo "(".$proveedor['prv_ruc'].") ".$proveedor['prv_razonsocial'];?></option>
                                                                            <?php }?>
                                                                        </select>
                                                                    </div>                                                                    
                                                                </div>
                                                                <?php   break;
                                                                        case 3: //por articulo 
                                                                            $articulos = consultas::get_datos("select * from v_articulo where art_cod in(select a.art_cod "
                                                                                    ...
                                                                                    . "join pedido_cabcompra b on a.ped_com =b.ped_com "
