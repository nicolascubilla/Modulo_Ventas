...
<body class="hold-transition skin-blue sidebar-mini">
                    ...
                    <div class="col-lg-13 col-md-13 col-sm-13">
                        <div class="box box-primary">
                            ...
                            <h2 class="text-center">
                               ...
                               Detalles de la orden producción</h2>
                                <div class="box-tools">
                                    <a href="orden_produccion_index.php" class="btn btn-primary btn-sm pull-right" title="Volver">
                            ...
                            <div class="box-body">
                                <?php
                                if (!empty($_GET['vord_cod'])) {
                                    $vord_cod = $_GET['vord_cod'];
                                    $orden = consultas::get_datos("SELECT * FROM v_orden_produccion_detalles WHERE ord_cod = $vord_cod");
    ...
    <span class="<?php 
        echo $cabecera['nombre'] == 'FINALIZADO' ? 'estado-FINALIZADO' : 
             ($cabecera['nombre'] == 'PENDIENTE' ? 'estado-pendiente' : 
             ($cabecera['nombre'] == 'ANULADO' ? 'estado-anulado' : '')); 
    ?>">
        <?php echo $cabecera['nombre']; ?>
    </span>
</td>

                                                <th>Usuario:</th>
                                                <td><?php echo $cabecera['usu_nick']; ?></td>
                                            </tr>
                                            <tr>
                                                <th>Sucursal:</th>
                                                <td><?php echo $cabecera['suc_descri']; ?></td>
                                        ...
                                        echo "<div class='alert alert-info'>No se encontraron detalles para la orden N° $vord_cod.</div>";
                                    }
                                } else {
