...
<html>
    <head>
        ...
        <title>LP3 - Agregar Material</title>
                        ...
                        <div class=" col-xs-12 col-lg-12 col-md-12">
                            ...
                            <div class="box box-primary">
                                ...
                                <form action="material_control.php" method="post" accept-charset="UTF-8" class="form-horizontal">
                                    ...
                                    <input type="hidden" name="vmaterial_id" value="0">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label class="col-lg-2 col-md-2 col-sm-2 control-label">Nombre del Material</label>
                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                <input type="text" class="form-control" name="vnombre_material" required minlength="3"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-lg-2 col-md-2 col-sm-2 control-label">Descripción</label>
                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                <textarea class="form-control" name="vdescripcion" rows="3"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-lg-2 col-md-2 col-sm-2 control-label">Unidad de Medida</label>
                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                <input type="text" class="form-control" name="vunidad_medida" required minlength="2"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
