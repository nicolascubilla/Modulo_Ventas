                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12">
                        <div class="box box-primary">
                            <div class="box-header">
                                ...
                                <div class="box-tools">
                                    <a href="presupuesto_compra_add.php" class="btn btn-primary btn-sm pull-right"
                                    ...
                                    <table id="pedidosTable" class="table table-bordered table-striped table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td
                                                    class="<?php echo 'estado-' . strtolower($Presu['estado_nombre']); ?>">
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a href="presupuesto_compra_print.php?vpresupuesto_id=<?php echo $Presu['presupuesto_id']; ?>"
                                                    ...
                                                    <a href="presupuesto_compra_detalles.php?vpresupuesto_id=<?php echo $Presu['presupuesto_id']; ?>"
                                                        class="btn btn-primary btn-sm" data-title="Ver Detalles"
                                                        rel="tooltip" target="_top">
                                                    ...
                                                    <a onclick="anular(<?php echo "'".$Presu['id_pedido']."_".$Presu['presupuesto_id']."'"; ?>)"
                                                        class="btn btn-danger btn-sm" role="button" data-title="Anular"
                                                        rel="tooltip" data-placement="top" data-toggle="modal"
                                                        data-target="#anular">
                                                        <span class="glyphicon glyphicon-remove"></span>
                                                    </a>

                                                    <a href="presupuesto_compra_editar?vpresupuesto_id=<?php echo $Presu['presupuesto_id'];?>"
                                                        class="btn btn-warning btn-sm" role="button" data-title="Editar"
