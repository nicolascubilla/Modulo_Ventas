                                    ...
                                    <div class="box-body">                                        
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                <label>Fecha:</label>
                                                <input type="text" name="vped_fecha" class="form-control" value="<?php echo $pedidos[0]['ped_fecha'];?>" disabled="">
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                ...
                                                <input type="text" name="vsucursal" 
                                                       class="form-control" value="<?php echo $pedidos[0]['suc_descri'];?>" disabled="">
                                            </div> 
                                            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                <label>Empleado:</label>
                                                <input type="text" name="vempleado" 
                                                       class="form-control" value="<?php echo $pedidos[0]['empleado'];?>" disabled="">                                                
                                            </div>
                                        </div>
                                    </div>
