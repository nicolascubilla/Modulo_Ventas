...
session_start();
$detalle= consultas::get_datos("select*from vdetalle_compra where com_cod=".$_REQUEST['vcom_cod'].
...
<form action="compras_dcontrol.php" method="post" accept-charset="UTF-8" class="form-horizontal">
    <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-4 col-sm-4 col-md-4 col-xs-6">
                <input type="number" name="vcom_precio" class="form-control" min="1" value="<?php echo $detalle[0]['com_precio']?>" required=""/>
            </div>
        </div>
    </div>
