                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="box box-primary">
                                ...
                                <form action="pagina_control.php" method="post" accept-charset="utf-8" class="form-horizontal">
                                    <?php $paginas = consultas::get_datos("select * from v_paginas where pag_cod =".$_GET['vpag_cod']);?>
                                    ...
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-4">
                                                <input type="text" class="form-control" name="vpag_direc" required="" autofocus="" value="<?php echo $paginas[0]['pag_direc'];?>"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-lg-2 col-md-2 col-sm-2">Nombre:</label>
                                            <div class="col-lg-4 col-md-4 col-sm-4">
                                                <input type="text" class="form-control" name="vpag_nombre" required="" autofocus="" value="<?php echo $paginas[0]['pag_nombre'];?>"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-lg-2 col-md-2 col-sm-2">Módulos:</label>
                                            <div class="col-lg-4 col-md-4 col-sm-4">
