                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="box box-primary">
                                <div class="box-header">
                                    ...
                                    <h3 class="box-title">Informe de Cargos</h3>
                                </div>
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                                                        <select class="form-control select2" name="vdesde">
                                                                            ...
                                                                            <option value="<?php if($opcion==1){echo $cargo['car_cod'];}else{echo $cargo['car_descri'];};?>"><?php if($opcion==1){echo $cargo['car_cod'];}else{echo $cargo['car_descri'];};?></option>
                                                                             <?php } ?>
                                                                        </select>
                                                                    </div>
                                                                </div>
