...
<head>
    ...
    .title-container {
        display: flex;
        align-items: center;
        /* Alinea el SVG y el título verticalmente */
        gap: 10px;
...
<body class="hold-transition skin-blue sidebar-mini">
        ...
        <div class="content-wrapper">
            <div class="content">
                        ...
                        <div class="box box-primary">
                            <div class="box-header">
                                <div class="title-container">
                                    <!-- Ícono SVG -->
                                    <svg width="64pt" height="64pt" viewBox="0 0 22.577778 22.577778" version="1.1"
                                        id="svg831" inkscape:version="1.1.2 (1:1.1+202202050950+0a00cf5339)"
                                        ...
                                        inkscape:export-xdpi="576" inkscape:export-ydpi="576"
                                        ...
                                        <defs id="defs825">
                                            <pattern id="EMFhbasepattern" patternUnits="userSpaceOnUse" width="6"
                                                height="6" x="0" y="0" />
                                            <pattern id="EMFhbasepattern-9" patternUnits="userSpaceOnUse" width="6"
                                                height="6" x="0" y="0" />
                                            <pattern id="EMFhbasepattern-0" patternUnits="userSpaceOnUse" width="6"
                                                height="6" x="0" y="0" />
                                            <pattern id="EMFhbasepattern-7" patternUnits="userSpaceOnUse" width="6"
                                                height="6" x="0" y="0" />
                                            <pattern id="EMFhbasepattern-2" patternUnits="userSpaceOnUse" width="6"
                                                height="6" x="0" y="0" />
                                            <pattern id="EMFhbasepattern-98" patternUnits="userSpaceOnUse" width="6"
                                                height="6" x="0" y="0" />
                                            <pattern id="EMFhbasepattern-6" patternUnits="userSpaceOnUse" width="6"
                                                height="6" x="0" y="0" />
                                            <pattern id="EMFhbasepattern-01" patternUnits="userSpaceOnUse" width="6"
                                                height="6" x="0" y="0" />
                                            <pattern id="EMFhbasepattern-07" patternUnits="userSpaceOnUse" width="6"
                                                height="6" x="0" y="0" />
                                            <pattern id="EMFhbasepattern-8" patternUnits="userSpaceOnUse" width="6"
                                                height="6" x="0" y="0" />
                                            <pattern id="EMFhbasepattern-4" patternUnits="userSpaceOnUse" width="6"
                                                height="6" x="0" y="0" />
                                            <pattern id="EMFhbasepattern-40" patternUnits="userSpaceOnUse" width="6"
                                                height="6" x="0" y="0" />
                                            <pattern id="EMFhbasepattern-08" patternUnits="userSpaceOnUse" width="6"
                                                height="6" x="0" y="0" />
                                            <pattern id="EMFhbasepattern-04" patternUnits="userSpaceOnUse" width="6"
                                                height="6" x="0" y="0" />
                                            <pattern id="EMFhbasepattern-014" patternUnits="userSpaceOnUse" width="6"
                                                height="6" x="0" y="0" />
                                            <pattern id="EMFhbasepattern-27" patternUnits="userSpaceOnUse" width="6"
                                                height="6" x="0" y="0" />
                                            <pattern id="EMFhbasepattern-09" patternUnits="userSpaceOnUse" width="6"
                                                height="6" x="0" y="0" />
                                            <pattern id="EMFhbasepattern-5" patternUnits="userSpaceOnUse" width="6"
                                                height="6" x="0" y="0" />
                                            <pattern id="EMFhbasepattern-018" patternUnits="userSpaceOnUse" width="6"
                                                height="6" x="0" y="0" />
                                        </defs>
                                        <sodipodi:namedview id="base" pagecolor="#ffffff" bordercolor="#666666"
                                            borderopacity="1.0" inkscape:pageopacity="0.0" inkscape:pageshadow="2"
                                            inkscape:zoom="4.4249417" inkscape:cx="19.322288" inkscape:cy="47.232261"
                                            inkscape:document-units="pt" inkscape:current-layer="layer1"
                                            showgrid="false" units="pt" inkscape:window-width="1366"
                                            inkscape:window-height="705" inkscape:window-x="0" inkscape:window-y="31"
                                            inkscape:window-maximized="1" inkscape:pagecheckerboard="true"
                                            inkscape:showpageshadow="false" inkscape:object-paths="true"
                                            inkscape:snap-intersection-paths="true" inkscape:snap-smooth-nodes="true"
                                            inkscape:snap-midpoints="true" showguides="true" inkscape:snap-bbox="true"
                                            ...
                                            <sodipodi:guide position="0.97013831,21.607643" orientation="78.000048,0"
                                                id="guide1380" inkscape:locked="false" />
                                            <sodipodi:guide position="0.97013831,0.97013129" orientation="0,78.000005"
                                                id="guide1382" inkscape:locked="false" />
                                            <sodipodi:guide position="21.607639,0.97013129" orientation="-78.000048,0"
                                                id="guide1384" inkscape:locked="false" />
                                            <sodipodi:guide position="21.607639,21.607643" orientation="0,-78.000005"
                                                id="guide1386" inkscape:locked="false" />
                                        </sodipodi:namedview>
                                        ...
                                        <g inkscape:label="Icon" inkscape:groupmode="layer" id="layer1"
                                            ...
                                            <g id="g236484" style="display:inline;stroke-width:0.794904"
                                                transform="matrix(1.2580135,0,0,1.2580135,-76.108606,159.94028)">
                                                <path
                                                ...
                                                <path id="path225727"
                                                    style="color:#000000;fill:#a8c2e1;fill-opacity:1;stroke-width:3.00436;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:1.5;-inkscape-stroke:none"
                                    ...
                                    <h2 class="title">Agregar Factura de Compras</h2>
                                </div>

                                <div class="box-tools">
                                    <a href="factura_compra_index.php" class="btn btn-primary btn-md"
                                        data-title="Volver">
                                    ...
                                    <div class="container">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4">
                                                ...
                                                <select class="form-control select2" name="vorden_id" id="orden"
                                                    onchange="cargarorden(this.value)" required>
                ...
                foreach ($orden as $ord) { ?>
                                            ...
                                            <div class="col-lg-4">
                                                <label for="buscar_orden" class="control-label">Buscar Orden
                                                    (ID):</label>
                                                <div class="input-group">
                                                    <input type="text" id="buscar_orden" class="form-control"
                                    ...
                                    <input type="text" id="id_factu_proveedor" name="vid_factu_proveedor"
                                        class="form-control"
                                        maxlength="13"
                                        pattern="\d{1,13}"
                                        title="Ingrese de 1 a 13 dígitos numéricos"
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-lg-4">
                                                <label for="prv_nombre" class="control-label">Proveedor
                                                    seleccionado:</label>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <input type="text" id="sucursal" name="vid_sucursal_visible"
                                                    class="form-control" value="<?php echo $_SESSION['sucursal']; ?>"
                                                    disabled>
                                                <input type="hidden" name="vid_sucursal"
                                                    value="<?php echo $_SESSION['id_sucursal']; ?>">
                                            </div>

                                            <div class="col-lg-4">
                                                <label for="vusuario" class="control-label">Usuario:</label>
                                                <input type="text" name="vusuario" class="form-control"
                                                    value="<?php echo $_SESSION['usu_nick']; ?>" disabled>
                                                <input type="hidden" name="vusu_cod"
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            ?>
                                                <input type="datetime-local" name="fecha_factura_visible"
                                                    class="form-control" value="<?php echo $fecha_formateada; ?>">
                                                <input type="hidden" name="vfecha_emision"
                                                    value="<?php echo $fecha[0]['fecha_emision']; ?>">
                                            </div>

                                            <div class="col-lg-4">
                                                <label for="monto_total" class="control-label">Monto total:</label>
                                                <input type="text" id="total" name="vmonto_total" class="form-control"
                                                    readonly>
                                            </div>

                                           <div class="col-lg-4">
                                        <label for="vtimbrado" class="control-label">N° Timbrado:</label>
                                        <input type="text" id="timbrado" name="vtimbrado"
                                            class="form-control"
                                            maxlength="8"
                                            pattern="\d{8}"
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-lg-3">
                                                ...
                                                <select class="form-control select2" name="vid_metodo_pago" id="id"
                                                    required>
                ...
                foreach ($metodo as $meto) { ?>
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <select class="form-control select2" name="vcondicion" required
                                                    id="condicion" onchange="tipocompra()">
                                            ...
                                            <div class="col-lg-2 tipo" style="display: none;">
                                                ...
                                                <input type="number" name="vfact_cuota" id="cuotas" class="form-control"
                                                    min="1" value="1">
                                            </div>
                                        ...
                                        <div class="row mt-3 mt-0">
                                            <div class="col-lg-3 mt-0">
                                                ...
                                                <select class="form-control select2" name="vdep_cod" id="vdep_cod"
                                                    required>
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tbody id="detalle_orden">
                                                    <tr>
                                                        <td colspan="5">Seleccione un presupuesto para cargar el
                                                            detalle.</td>
                                                    </tr>
                                                </tbody>
                                            </table>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (firstOption) {
                        ...
                        $('#detalle_orden').html(
                            '<tr><td colspan="3">No se encontró ninguna orden con el ID ingresado.</td></tr>'
                            );
                    }
                },
                error: function() {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let montoFormateado = new Intl.NumberFormat('es-PY', {
            style: 'decimal',
