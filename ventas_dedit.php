...
$detalles = consultas::get_datos("select * from v_detalle_ventas "
        . "where ven_cod =".$_REQUEST['vven_cod']." and dep_cod=".$_REQUEST['vdep_cod']
        ." and art_cod=".$_REQUEST['vart_cod']);
//var_dump($detalles);
?>
<div class="modal-header">
    <button type="button" class="close" data-dismiss="modal" aria-label="Close">x</button>
    <h4 class="modal-title"><i class="fa fa-edit"></i> <strong>Editar Item Venta</strong></h4>
</div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4">
                <input type="number" name="vven_cant" class="form-control" required="" autofocus="" 
                       placeholder="Ingrese la cantidad" value="<?php echo $detalles[0]['ven_cant'];?>" min="1"/>                                                
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-lg-5 col-md-5 col-sm-5">
                <input type="number" name="vven_precio" class="form-control" required="" 
                       placeholder="Ingrese el precio" value="<?php echo $detalles[0]['ven_precio'];?>" min="1"/>                                                
            </div>
        </div>        
    </div>
