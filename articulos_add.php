                                ...
                                <form action="articulos_control.php" method="post" acept-charset='UTF-8' class="form-horizontal">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                <div class="input-group">
                                                    <?php $marca= consultas::get_datos("select*from marca order by mar_descri")?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                <input type='number' class='form-control' name='vart_precioc' 
                                                       required autofocus min="0" value="0"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                <div class="input-group">
                                                    <?php $tipos= consultas::get_datos("select*from tipo_impuesto order by tipo_descri")?>
