    ...
    <body class="hold-transition skin-blue sidebar-mini">
                            ...
                            <div class="box box-primary">
                                <div class="box-header">
                                    ...
                                    <div class="box-tools">
                                        ...
                                        <a href="modulo_print.php" class="btn btn-default btn-sm" data-title="Imprimir" rel="tooltip" target="print">
                                ...
                                <div class="box-body">
                                    ...
                                    <?php $modulos = consultas::get_datos("select * from modulos where mod_nombre ilike '%".(isset($_REQUEST['buscar']) ? $_REQUEST['buscar']:"")."%'order by mod_cod");
                                        if (!empty($modulos)) { ?>
                                                ...
                                                <?php foreach ($modulos as $modulo) { ?>
                                                    <tr>
                                                        ...
                                                        <td data-title='Acciones' class="text-center">
                                                            <a onclick="editar(<?php echo "'" . $modulo['mod_cod'] . "_" . $modulo['mod_nombre'] . "'"; ?>)" class="btn btn-warning btn-sm" data-title="Editar" 
                                                               rel="tooltip" data-toggle="modal" data-target="#editar">
                                                                <i class="fa fa-edit"></i>
                                                            </a>
                                                            <a onclick="borrar(<?php echo "'" . $modulo['mod_cod'] . "_" . $modulo['mod_nombre'] . "'"; ?>)" class="btn btn-danger btn-sm" data-title="Borrar" 
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-10">
                                        <input type="text" name="vmod_nombre" class="form-control" required="" autofocus="" placeholder="Ingrese la descripción del módulo"/>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="modal fade" id="editar" role="dialog">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">x</button>
                            <h4 class="modal-title"><i class="fa fa-edit"></i> <strong>Editar Módulos</strong></h4>
                        </div>
                        <form action="modulo_control.php" method="post" accept-charset="UTF-8" class="form-horizontal">
                            <input type="hidden" name="accion" value="2"/>
                            <input type="hidden" name="vmod_cod" value="0" id="cod"/>
                            <div class="modal-body">
                                <div class="form-group">
                                    <label class="control-label col-lg-2 col-md-2 col-sm-2">Descripción:</label>
                                    <div class="col-lg-8 col-md-8 col-sm-10">
                                        <input type="text" name="vmod_nombre" id="descri" class="form-control" required="" autofocus="" placeholder="Ingrese la descripción del módulo"/>
                                    </div>
                                </div>
                            </div>
                            <div class="modal-footer">
                                ...
                                <button type="submit" class="btn btn-warning" data-title="Guardar Grupo" rel="tooltip">
        ...
        <script>
            function editar(datos) {
                ...
                $("#cod").val(dat[0]);
                $("#descri").val(dat[1]).select();
            }
            ;
            function borrar(datos) {
                var dat = datos.split("_");
                $("#si").attr('href', 'modulo_control.php?vmod_cod=' + dat[0] + '&accion=3');
                $("#confirmacion").html("<span class='glyphicon glyphicon-warning-sign'>\n\
                </span> Desea borrar el módulo <strong>" + dat[1] + "</strong>?");
            }
        </script>
    </body>
</html>