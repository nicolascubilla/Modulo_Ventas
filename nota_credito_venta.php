...
<head>
    <meta charset="utf-8">
    <title>Agregar Nota de Crédito de Venta</title>
    <?php
    session_start();
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="box box-primary">
                        <div class="box-header">
                            ...
                            <h3 class="box-title">Agregar Nota de Crédito de Venta</h3>
                            <div class="box-tools">
                                <a href="nota_credito_venta_index.php" class="btn btn-primary btn-md" data-title="Volver">
                                    <i class="fa fa-arrow-left"></i>
                                </a>
                            </div>
                        </div>

                        <form action="nota_credito_venta_control.php" method="post" class="form-horizontal">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        $fecha = consultas::get_datos("SELECT CURRENT_TIMESTAMP AS fecha_nc");
                                        $fecha_formateada = date('Y-m-d\TH:i', strtotime($fecha[0]['fecha_nc']));
                                        ?>
                                        <input type="datetime-local" name="fecha_visible" class="form-control"
                                               value="<?php echo $fecha_formateada; ?>" disabled>
                                        <input type="hidden" name="vfecha" value="<?php echo $fecha[0]['fecha_nc']; ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-12">
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody id="detalle_nc">
                                            <tr>
                                                <td colspan="7">Seleccione artículos para la nota de crédito.</td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
