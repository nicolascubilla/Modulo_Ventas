                        ...
                        <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                            <div class="box box-warning">
                                <div class="box-header">
                                    ...
                                    <div class="box-tools">
                                        <a href="presupuestocliente_index.php" class="btn btn-primary btn-md" data-title="Volver" rel="tooltip">
                                            <i class="fa fa-arrow-left"></i></a>
                                    </div>
                                </div>                    
                                <?php $presupuesto = consultas::get_datos("select * from v_presupuesto_producc_cabecera where pre_cod =".$_REQUEST['vpre_cod']);
                                if(!empty($presupuesto)){
                                ?>
                                <form action="presupuestocli_control.php" method="post" accept-charset="utf-8" class="form-horizontal">
                                        <input type="hidden" name="accion" value="2">
                                        <input type="hidden" name="vpre_cod" value="<?php echo $presupuesto[0]['pre_cod'];?>">                                    
                                    <div class="box-body">                                        
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                <label>Fecha:</label>
                                                <input type="text" name="pre_fechaemision" class="form-control" value="<?php echo $presupuesto[0]['fecha'];?>" disabled="">
                                            </div>
                                            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                <label>Cliente:</label>
                                                <div class="input-group">
                                                <?php $clientes = consultas::get_datos("select * from clientes order by cli_cod=".$presupuesto[0]['cli_cod']." desc");?>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                ...
                                                <input type="text" name="vsucursal" 
                                                       class="form-control" value="<?php echo $presupuesto[0]['suc_descri'];?>" disabled="">
                                            </div> 
                                            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                <label>Empleado:</label>
                                                <input type="text" name="vempleado" 
                                                       class="form-control" value="<?php echo $presupuesto[0]['empleado'];?>" disabled="">                                                
                                            </div>
                                        </div>
                                    </div>
                                    <div class="box-footer">
                                        <button type="submit" class="btn btn-warning pull-right" data-title="Presione para guardar" rel="tooltip">
                                ...
                                <div class="box-body">
                                        <div class="alert alert-danger">
                                            ...
                                            No se encontro pedido de venta coincidente...
                                        </div>                                                                        
                                </div>
                                <?php } ?>
                            </div>
