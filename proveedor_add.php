                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-6 col-md-4 col-sm-4">
                                                <input type="text" name="vprv_ruc" class="form-control" required="" autofocus="" minlength="3" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-lg-2 col-md-2 col-sm-2">Razón Social:</label>
                                            <div class="col-lg-8 col-md-6 col-sm-6">
                                                <input type="text" name="vprv_razonsocial" class="form-control" required="" minlength="3" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-lg-2 col-md-2 col-sm-2">Dirección:</label>
                                            <div class="col-lg-8 col-md-6 col-sm-6">
                                                <input type="text" name="vprv_direccion" class="form-control" required="" minlength="3" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-lg-2 col-md-2 col-sm-2">Teléfono:</label>
                                            <div class="col-lg-6 col-md-4 col-sm-4">
                                                <input type="text" name="vprv_telefono" class="form-control" required="" minlength="3" />
                                            </div>
                                        </div>   
                                    </div>
