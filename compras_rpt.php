                                                            ...
                                                            <div class="panel-body">
                                                                ...
                                                                <?php  break;
                                                                        case 2: //por proveedor 
                                                                            $proves = consultas::get_datos("select * from proveedor where prv_cod in(select prv_cod "
                                                                                    . "from compras where id_sucursal =".$_SESSION['id_sucursal']." )"); ?>
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-lg-8 col-sm-8 col-md-8">
                                                                        <select class="form-control select2" name="vpro">
                                                                            ...
                                                                            <?php foreach ($proves as $pro) { ?>
                                                                                 <option value="<?php echo $pro['prv_cod'];?>">
                                                                                     <?php echo $pro['prv_razonsocial'];?></option>
                                                                            <?php }?>
                                                                        </select>
                                                                    </div>                                                                    
                                                                </div>
                                                                <?php   break;
                                                                        case 3: //por articulo 
                                                                            $articulos = consultas::get_datos("select * from v_articulo where art_cod in(select a.art_cod "
                                                                                    ...
                                                                                    . "join compras b on a.com_cod =b.com_cod "
