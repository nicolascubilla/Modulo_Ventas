...
<head>
    ...
    .estado-pendiente {
        ...
        border-radius: 5px;
        padding: 3px 6px;
        /* Reducir padding para que sea más compacto */
        text-align: center;
    }
    ...
    table tbody tr {
        height: 30px;
        /* Ajustar a la altura que desees */
    }
    ...
    .estado-anulado {
        ...
        /* Bordes redondeados */
        padding: 5px 15px;
        /* Relleno para dar espacio dentro del botón */
        text-transform: uppercase;
        /* Texto en mayúsculas */
        display: inline-block;
        /* Hace que se comporte como un botón */
    }
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12">
                        <div class="box box-primary">
                            <div class="box-header">
                                ...
                                <div class="box-tools">
                                    <a href="pedcompra_add.php" class="btn btn-primary btn-sm pull-right"
        ...
        ?>
                                            <tr>
                                                <td class="text-center">
                                                    <?php echo htmlspecialchars($Ped['id_pedido']); ?></td>
                                                <td class="text-center">
                                                    <?php echo htmlspecialchars($Ped['fecha_pedido']); ?></td>
                                                <td class="<?php echo $claseEstado; ?>">
                                                    <?php echo htmlspecialchars($Ped['estado']); ?></td>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a href="pedcompra_print?vid_pedido=<?php echo $Ped['id_pedido']; ?>"
                                                        class="btn btn-default btn-md" data-title="Imprimir"
                                                        rel="tooltip" target="print">
                                                        <i class="fa fa-print"></i>
                                                    </a>
                                                    <a href="pedcompra_edit.php?vid_pedido=<?php echo $Ped['id_pedido']; ?>"
                                                        class="btn btn-warning btn-sm" title="Editar">
                                                        <i class="glyphicon glyphicon-edit"></i>
                                                    </a>
                                                    <a onclick="anular('<?php echo $Ped['id_pedido'] . '_' . $Ped['id_pedido']; ?>')"
                                                        class="btn btn-danger btn-sm" data-toggle="modal"
                                                        data-target="#anular" title="Anular">
                                                        <i class="fa fa-remove"></i>
                                                    </a>
                                                    <a href="pedcompra_det.php?vid_pedido=<?php echo $Ped['id_pedido']; ?>"
