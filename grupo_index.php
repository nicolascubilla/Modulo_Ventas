    ...
    <body class="hold-transition skin-blue sidebar-mini">
                        ...
                        <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                            ...
                            <div class="box box-primary">
                                ...
                                <div class="box-body">
                                    ...
                                    <?php $grupos = consultas::get_datos("select * from grupos where gru_nombre ilike '%".(isset($_REQUEST['buscar']) ? $_REQUEST['buscar']:"")."%'order by gru_cod");
                                        if (!empty($grupos)) { ?>
                                                ...
                                                <?php foreach ($grupos as $grupo) { ?>
                                                    <tr>
                                                        ...
                                                        <td data-title='Acciones' class="text-center">
                                                            <a onclick="editar(<?php echo "'" . $grupo['gru_cod'] . "_" . $grupo['gru_nombre'] . "'"; ?>)" class="btn btn-warning btn-sm" data-title="Editar" 
                                                               rel="tooltip" data-toggle="modal" data-target="#editar">
                                                                <i class="fa fa-edit"></i>
                                                            </a>
                                                            <a onclick="borrar(<?php echo "'" . $grupo['gru_cod'] . "_" . $grupo['gru_nombre'] . "'"; ?>)" class="btn btn-danger btn-sm" data-title="Borrar" 
                    ...
                    <div class="modal-content">
                        ...
                        <form action="grupo_control.php" method="post" accept-charset="UTF-8" class="form-horizontal">
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-10">
                                        <input type="text" name="vgru_nombre" class="form-control" required="" autofocus="" placeholder="Ingrese la descripción del grupo"/>
                                    </div>
                                </div>
                            </div>
                            <div class="modal-footer">
                                ...
                                <button type="submit" class="btn btn-success" data-title="Guardar Grupo" rel="tooltip">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form action="grupo_control.php" method="post" accept-charset="UTF-8" class="form-horizontal">
                            ...
                            <input type="hidden" name="vgru_cod" value="0" id="cod"/>
                            <div class="modal-body">
                                <div class="form-group">
                                    <label class="control-label col-lg-2 col-md-2 col-sm-2">Descripción:</label>
                                    <div class="col-lg-8 col-md-8 col-sm-10">
                                        <input type="text" name="vgru_nombre" id="descri" class="form-control" required="" autofocus="" placeholder="Ingrese la descripción del grupo"/>
                                    </div>
                                </div>
                            </div>
                            <div class="modal-footer">
        ...
        <script>
            ...
            function borrar(datos) {
                var dat = datos.split("_");
                $("#si").attr('href', 'grupo_control.php?vgru_cod=' + dat[0] + '&accion=3');
                $("#confirmacion").html("<span class='glyphicon glyphicon-warning-sign'>\n\
                </span> Desea borrar el grupo <strong>" + dat[1] + "</strong>?");
            }
        </script>
    </body>
</html>